      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="sigma_product-single-content">
            ...
            <h4 class="entry-title"> Gita Book </h4>
            ...
            <form class="sigma_product-atc-form">
              ...
              <div class="qty-outter">
                <a href="product-single.html" class="sigma_btn-custom">Buy Now</a>
                <div class="qty-inner">
                  <h6>Qty:</h6>
                  <div class="qty">
                    <span class="qty-subtract"><i class="fa fa-minus"></i></span>
    ...
    <div class="container">
      <div class="sigma_product-additional-info">
        ...
        <ul class="nav" id="bordered-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="tab-product-info-tab" data-bs-toggle="pill" href="#tab-product-info" role="tab" aria-controls="tab-product-info" aria-selected="false">Additional Information</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="tab-product-reviews-tab" data-bs-toggle="pill" href="#tab-product-reviews" role="tab" aria-controls="tab-product-reviews" aria-selected="false">Reviews </a>
          </li>
        </ul>
