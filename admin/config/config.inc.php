...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=wisdom_tooth;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/wisdomtooth/admin/';
    $fsitename = 'http://localhost/wisdomtooth/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/wisdom_tooth-microwebz/";
} else {

    $db = new PDO('mysql:host=localhost;dbname=kovil;charset=utf8mb4', 'kovil', 'kovil');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "kovil", 'kovil', "kovil");
    $sitename = "https://ttbilling.in/koviltemplate/admin/";
    $site = 'https://ttbilling.in/koviltemplate/admin/';
    $fsitename = 'https://ttbilling.in/koviltemplate/';
