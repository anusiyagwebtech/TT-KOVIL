            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addblog.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
                  <h4 class="page-title">Blog</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>">Kovil</a></li>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Blog</h4>
...
?>
                 ...
                 <form name="form1" method="post" action="">
                                ...
                                <tr align="center">
                                  ...
                                  <th style="text-align: left;">Status</th> Order
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editblog.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=blog_table"
    });
	function changeorder(a, b) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $sitename; ?>pages/order.php",
            data: {table: 'category', order: a, id: b},
            success: function (data) {
              window.location.replace("<?php echo $sitename; ?>master/blog.htm");
            }
