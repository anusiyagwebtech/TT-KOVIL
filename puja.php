      ...
      <div class="portfolio-filter row">
        <div class="col-lg-4 coaching">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/13.jpg" alt="portfolio">
        ...
        <div class="col-lg-4 strategy">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/14.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Raksha Bandhan </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/15.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Janmashtmi </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 relations coaching">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/16.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Mahashivratri </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 stakeholder strategy">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/17.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Holi </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 stakeholder">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/12.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
        ...
        <div class="col-lg-4 coaching">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/7.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Holi-Colour Festival </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 relations">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/8.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Holi's Ministry </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 relations coaching">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/9.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Labour Ministry </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 stakeholder strategy">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/10.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Event Ministry </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 stakeholder">
          <div class="sigma_portfolio-item">
            <img src="assets/img/puja/11.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Temple Minsitry </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
        ...
        <div class="col-lg-4 coaching">
          <div class="sigma_portfolio-item">
            ...
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="puja-details.html"> Durga Mahastami </a> </h5>
                <p>Puja is the worship of the Lord, consectet ur adipisicing elit, sed do eiusmod</p>
              </div>
              <a href="puja-details.html"><i class="fal fa-plus"></i></a>
            </div>
