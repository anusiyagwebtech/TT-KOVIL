    ...
    <div class="container">
      <div class="sigma_subheader-inner">
        <div class="sigma_subheader-text">
          <h1>நன்கொடையாளர்கள் </h1>
        </div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a class="btn-link" href="index.php">முகப்பு</a></li>
            <li class="breadcrumb-item active" aria-current="page">நன்கொடையாளர்கள் </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="portfolio-filter row">
        ...
        <div class="col-lg-4 strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/2a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
              <a href="puja-details.html"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/3b.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/4a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/5a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/6a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/7a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/8a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="assets/img/puja/details/9a.jpeg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="#"></a> </h5>
              </div>
